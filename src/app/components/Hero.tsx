    ...
    <section className="min-h-screen flex items-center justify-center px-6 py-20 bg-gradient-to-br from-violet-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          >
            Pomagam Małym Firmom Zaistnieć Online ✨
          </motion.span>
        </motion.div>
        
        <motion.h1 
          className="text-5xl md:text-7xl mb-6 bg-gradient-to-r from-violet-600 via-purple-600 to-pink-600 bg-clip-text text-transparent"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
        >
          Cześć, jestem Alex Morgan
        </motion.h1>
        ...
        >
          Tworzę piękne, przystępne cenowo strony internetowe, które pomagają właścicielom małych firm dotrzeć do większej liczby klientów i rozwijać biznes
        </motion.p>
